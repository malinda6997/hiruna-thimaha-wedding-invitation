...
export default function StorySection() {
  ...
  return (
    <section
      id="chapter-story"
      ref={containerRef}
      className="relative min-h-screen w-full bg-[#030206] text-white py-16 px-6 flex flex-col items-center justify-center overflow-hidden select-none"
    >
      <style jsx global>{`
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] sm:w-[600px] h-[350px] sm:h-[600px] rounded-full bg-purple-900/15 blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto mb-10">
        ...
        <h2 className="story-fade-in story-font-lora italic text-2xl sm:text-4xl text-purple-100 font-normal leading-relaxed mb-4 drop-shadow-md">
      ...
      <div
        ref={imgWrapperRef}
        className="relative z-10 w-full max-w-md sm:max-w-lg h-[400px] sm:h-[530px] rounded-t-[180px] sm:rounded-t-[220px] rounded-b-3xl overflow-hidden border border-purple-500/20 shadow-[0_10px_40px_rgba(88,28,135,0.25)] bg-purple-950/30 backdrop-blur-sm p-2 mb-10"
      >
      ...
      <div className="relative z-10 text-center max-w-xl mx-auto">
        <div className="story-fade-in inline-flex items-center gap-2 mb-2">
        ...
        <h3 className="story-fade-in story-font-cinzel text-3xl sm:text-5xl font-bold tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-white via-purple-200 to-white mb-3">
          HIRUNA & THIMASHA
        </h3>
